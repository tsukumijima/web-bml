...
exports.OverlayInputApplication = void 0;
// Y=110未満には表示してはいけない (TR-B14 第二分冊 1.6)
class OverlayInputApplication {
    container;
    input;
    submitButton;
    cancelButton;
    ...
    launch({ characterType, allowedCharacters, maxLength, value, inputMode, callback }) {
...
exports.OverlayInputApplication = OverlayInputApplication;
//# sourceMappingURL=overlay_input.js.map