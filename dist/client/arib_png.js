...
exports.preparePLTE = preparePLTE;
exports.prepareTRNS = prepareTRNS;
exports.aribPNGToPNG = aribPNGToPNG;
const crc_32_1 = __importDefault(require("crc-32"));
function preparePLTE(clut) {
    ...
    view.setInt32(off, crc_32_1.default.buf(plte.subarray(4, off), 0));
    return plte;
}
function prepareTRNS(clut) {
    ...
    view.setInt32(off, crc_32_1.default.buf(trns.subarray(4, off), 0));
    return trns;
}
function replacePLTE(png, plte, trns) {
...
function aribPNGToPNG(png, clut) {
...
//# sourceMappingURL=arib_png.js.map