...
exports.decodeShiftJIS = decodeShiftJIS;
exports.encodeShiftJIS = encodeShiftJIS;
exports.stripStringShiftJIS = stripStringShiftJIS;
const jis_to_unicode_map_1 = require("./jis_to_unicode_map");
const unicode_to_jis_map_1 = require("./unicode_to_jis_map");
function decodeShiftJIS(input) {
    if (input.length === 0) {
        return "";
    }
...
function stripStringShiftJIS(input, maxBytes) {
    // 1, 2バイト文字しか存在しない
